...
Follow [Install instruction](/docs/install/#3-wsl-install-script)

## 3. Prepare a tar image for sharing

Follow [Install instruction](/docs/contribute/#2-how-to-prepare-an-new-image)
...
Follow [Install instruction](/docs/install/#3-wsl-install-script) it will build docker images and copy missing files on the
new computer

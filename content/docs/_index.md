...
description: Complete documentation for Bash Dev Env
type: docs
weight: 1
...
[bash tools framework](https://bash-tools-framework.devlab.top/) allowing to easily install several softwares on ubuntu
...
please follow [Dev-env Installation instructions](https://bash-dev-env.devlab.top/docs/install/)
...
- [Contribute](https://bash-dev-env.devlab.top/docs/contribute/)
- [How does it work ?](https://bash-dev-env.devlab.top/docs/how-does-it-work/)
